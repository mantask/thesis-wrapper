...
public class DataRecordLocatorTest {
    ...
    public void testLocateBasicRegions() throws Exception {
        List<Tree> regionTrees = DataRecordLocator.locate(Fixture.tableHtml.child(0));
    ...
    public void testLocateNonExistentRegions() throws Exception {
        List<Tree> regionTrees = DataRecordLocator.locate(Fixture.origHtml.child(1));
        assertEquals(0, regionTrees.size());
    }

    @Test
    public void testLocateMoreComplexTable() throws Exception {
        List<Tree> regionTrees = DataRecordLocator.locate(Fixture.movieHtml);
